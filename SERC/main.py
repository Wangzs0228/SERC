...
parser.add_argument(
    "--target_dataset", type=str, default=None, choices=dataset_names, help="Target Dataset to use."
)
parser.add_argument(
    "--model",
    type=str,
...
if palette is None:
    # Generate color palette
    palette={0: (0, 0, 0),1:(0,31,255),2:(0,175,255),3:(63,255,191),4:(219,255,41),5:(255,159,0),6:(255,15,0),7:(127,0,0)}
    if DATASET=="Hangzhou":
...
for run in range(N_RUNS):
    ...
    if MODEL == "SVM_grid":
        ...
        train_dataset_t = HyperX(img_t, val_gt, **hyperparams)
