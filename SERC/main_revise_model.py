...
from models_revise_model import get_model, train, test, save_model, Mytest,val
...
group_train.add_argument("--layernum",type=int,default=1,)
...
wandb.init(project="SERC107", name=DATASET + " " + MODEL+str(args.layernum))
