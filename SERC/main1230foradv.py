...
from models_adv import get_model, train, test, save_model
...
for run in range(N_RUNS):
    ...
    if MODEL == "SVM_grid":
        ...
        domain_discri1=DomainDiscriminator(104, hidden_size=128)
        ...
        # hyperparams.update({'patch_size': 7,})
        train_dataset_adv_s = HyperX(img, train_gt, **hyperparams)
        train_loader_adv_s = data.DataLoader(
            train_dataset_adv_s,
            batch_size=hyperparams["batch_size"],
            # pin_memory=hyperparams['device'],
            shuffle=True,
        ...
        train_dataset_adv_t = HyperX(img_t, train_t_gt, **hyperparams)
        train_loader_adv_t = data.DataLoader(
            train_dataset_adv_t,
            shuffle=True,
            # pin_memory=hyperparams['device'],
            batch_size=hyperparams["batch_size"],
