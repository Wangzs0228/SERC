...
# def visualize(source_feature: torch.Tensor, target_feature: torch.Tensor,y: torch.Tensor,label, source_color='r', target_color='b'):
#     """
...
#     markers = {0: 'o', 1: 's', 2: 'D',3: 'v',4: 'p',5: '*',6: 'p',7: '<',}  # 分别对应三种类别
#     colors = {0: "b",1: "r"}
...
#                             marker=markers[y[i].item()],
#                             alpha=0.7)
#     # plt.scatter(X_tsne[:, 0], X_tsne[:, 1], c=domains,marker=markers[y[i]], cmap=col.ListedColormap([target_color, source_color]), s=20)
#     plt.xticks([])
#     plt.yticks([])
